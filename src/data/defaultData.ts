...
export const INITIAL_SAMPLE_ORDERS: import('../types/production').ProductionOrder[] = [
  {
    ...
    client: 'AgroFértil Nutrição Animal',
    modelDescription: 'Big Bag 90x90x120cm - 4 Alças + Válvula Enchimento/Descarga + Liner',
    targetQuantity: 1500,
    ...
    selectedOperationIds: [
      ...
      'fundo-op-padrao',
      'fechamento-corpo',
      'topo-valvula-enchimento',
      'preparacao-inspecao',
      'preparacao-prensa'
    ],
    standardTimePerBag: 12.50,
    totalStandardTime: 18750,
    actualTimeTotal: 6617,
    componentTimes: {
      alca: 1120,
      fundo: 780,
      topo: 780,
    ...
    operatorName: 'Célula Alfa (Costura 1 e 2)',
    shift: '1º Turno',
    status: 'em_producao',
    notes: 'Lote prioritário para exportação de farelo de soja. Requer inspeção visual de costura 100% e teste de estanqueidade no liner.',
  ...
  },
  {
    ...
    client: 'PetroQuímica Bahia Sul',
    modelDescription: 'Big Bag Tubular 100x100x140cm - Travas Internas Q-Bag (Anti-Abaulamento)',
    targetQuantity: 800,
    producedQuantity: 0,
    selectedOperationIds: [
      'alca-op-padrao',
      'fundo-op-padrao',
      'fechamento-corpo',
      'travas-costura-4-cantos',
      'preparacao-inspecao'
    ],
    standardTimePerBag: 16.80,
    totalStandardTime: 13440,
    operatorName: 'Célula Beta (Especial Q-Bag)',
    shift: '2º Turno',
    status: 'planejada',
    notes: 'Modelo Q-Bag com defletores internos perfurados para estabilização de polímeros granulados em contêiner marítimo.',
  ...
  },
  {
    ...
    client: 'Mineração Vale do São Francisco',
    modelDescription: 'Big Bag Carga Pesada 95x95x130cm - Alças Estiva Reforçadas 2.000kg',
    targetQuantity: 2000,
    ...
    standardTimePerBag: 9.80,
    totalStandardTime: 19600,
    actualTimeTotal: 20850,
    componentTimes: {
      alca: 5000,
      fundo: 3500,
      fechamento: 8350,
    ...
    operatorName: 'Célula Gamma (Linha Pesada)',
    shift: 'Geral',
    status: 'concluida',
    notes: 'Lote concluído com sucesso e despachado. Eficiência média real atingida de 94% com zero retrabalho.',
